...
TOKEN_SPEC = [
    ...
    ("COMMA", r","),
    ("ARROW", r"=>"),
    ("KEYWORD", r"MODULE|IMPORT|TYPE|ENUM|STRUCT|UNION|TRAIT|IMPL|FUNC|LET|CONST|RETURN|IF|ELSE|MATCH|CASE|OTHERWISE|LOOP|SPAWN|SEND|RECV|AWAIT|TRY|CATCH|FINALLY|SET"),
